...
tit = rand(40)
fill(255,90,0,30)
ellipse(width-200,y-300,tit*10,tit*10)

# tit = rand(40)
strokeWeight(rand(200).to_f / 10.0)
stroke(0,0,0,rand(255))
ellipse(x*@sin,y*@cos-200,tit*10,tit*10)
...
lit = rand(width/2)
boots = [lit,height-lit,rand(lit),rand(y),rand(width),rand(height),width-lit,height-rand(200)]
